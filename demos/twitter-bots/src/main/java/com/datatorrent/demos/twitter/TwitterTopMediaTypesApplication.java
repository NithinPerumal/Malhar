 ...
 * @since 0.3.2
 */
@ApplicationAnnotation(name="RollingTopMediaTypesDemo")
public class TwitterTopMediaTypesApplication implements StreamingApplication
{
  ...
  public void populateDAG(DAG dag, Configuration conf)
  {
      ...
      TwitterStatusMediaTypeExtractor MediaTypeExtractor = dag.addOperator("WordExtractor", TwitterStatusMediaTypeExtractor.class);
      UniqueCounter<String> uniqueCounter = dag.addOperator("UniqueMediaTypeCounter", new UniqueCounter<String>());
      WindowedTopCounter<String> topCounts = dag.addOperator("TopCounter", new WindowedTopCounter<String>());
      topCounts.setSlidingWindowWidth(120, 1);
     
	  
      dag.addStream("TweetStream", twitterFeed.status, MediaTypeExtractor.input);
      ...
      ConsoleOutputOperator consoleOperator = dag.addOperator("topTypes", new ConsoleOutputOperator());
      dag.addStream("TopTypes", topCounts.output, consoleOperator.input);
  }
}
